 ...
 * Register block
 */
export default registerBlockType("jsforwpblocks/text-alignment-toolbar", {
  title: __("Example - Text Alignment Toolbar", "jsforwpblocks"),
  description: __(
    "How to add an alignment toolbar to a block for aligning text.",
    "jsforwpblocks"
  ),
  category: "common",
  icon: {
